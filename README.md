...
Open-source **[Django Dashboard](https://appseed.us/admin-dashboards/django/)** generated by `AppSeed` on top of an iconic design. For newcomers, **SB Admin** is one of the best open-source admin dashboard & control panel themes. Built on top of Bootstrap, `SB Admin` provides a range of responsive, reusable, and commonly used components. 
...
```bash
$ git clone https://app-generator/django-sb-admin.git
$ cd django-sb-admin
```
...
---
[SB Admin Django](https://appseed.us/product/sb-admin/django/) - Open-source starter generated by **[AppSeed Generator](https://appseed.us/generator/)**.
